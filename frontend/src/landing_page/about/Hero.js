      ...
      <div className="row  border-top mt-5  ">
        ...
        <div className="col-6 mt-5 ">
            <div>
                ...
                <p>
                   <a href=""  className='text-decoration-none' >Rainmatte</a>,
                    our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
