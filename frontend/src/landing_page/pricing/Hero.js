    ...
    <div className="container">
      ...
      <div className="row  mt-5">
        ...
        <div className="col-4 text-center">
          ...
          <p>
            Flat ₹ 20 or 0.03% (whichever is lower) <br/>  per executed order on intraday trades <br/> across equity, currency, and commodity <br/> trades. Flat ₹20 on all option trades.
          </p>
        </div>
